...
CHARACTERS = sorted([
    ...
    Wish("5.0", 'Kinich', '2024-09-27', five_star=True, benched=False),
    ...
    Wish("3.5", "Dehya", "2023-06-26", five_star=True, constellation=3, benched=False),
    ...
    Wish("1.4", "Rosaria", "2022-05-08", constellation=6, benched=False),
